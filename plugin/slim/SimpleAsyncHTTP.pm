...
=comment
	This file is overriding the default Slim::Networking::SimpleAsyncHTTP
	_createHTTPRequest method method to pass parameters received when the
	new method has been called
=cut
